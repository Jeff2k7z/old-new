    ...
    for (i = 0; i < ids.length; i++) {
        ...
        if (!isIE8) {
            if (i > 0) {
                ...
                thumbContainer[addEventListener]('mousedown', startDragging.bind(pair))
                thumbContainer[addEventListener]('touchstart', startDragging.bind(pair))

                gutter.appendChild(thumbContainer);

                var thumb = document.createElement('img');
                thumb.className = 'thumb';

                thumb[addEventListener]('mousedown', startDragging.bind(pair))
                thumb[addEventListener]('touchstart', startDragging.bind(pair))
